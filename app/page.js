...
const EVENT_DATE = new Date("2026-10-09T14:00:00+07:00");

const EVENT_LOCATION =
  "Jl. Kamp. Duri Dalam no.16 Rt 003/003, Duri Selatan, Tambora, Jakarta Barat, 11270";

const MAPS_URL = "https://maps.app.goo.gl/s4fTrDm5hJCgkHJi9";
...
export default function Home() {
  ...
  const [sapaan, setSapaan] = useState("Bapak/Ibu/Saudara/i");
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-[var(--sage-900)]">
      ...
      >
        ...
        <SprigCorner
          className="top-0 left-0 w-28 h-28 sm:w-36 sm:h-36 text-[var(--champagne)]/30 anim-sway"
        />
        ...
        <SprigCorner
          className="bottom-0 left-0 w-24 h-24 sm:w-32 sm:h-32 text-[var(--sage-300)]/25 anim-float"
        />
      ...
      <div className={opened ? "" : "invisible"}>
        ...
        <section className="relative min-h-[760px] flex items-center justify-center overflow-hidden bg-[var(--sage-800)] text-[var(--cream)] px-6 py-32 text-center">
          ...
          <SprigCorner
            className="top-0 left-0 w-44 h-44 text-[var(--champagne)]/30 anim-sway"
          />
          ...
          <SprigCorner
            className="bottom-0 left-0 w-36 h-36 text-[var(--sage-300)]/25 anim-float"
          />
          ...
          <div className="relative z-10 max-w-3xl mx-auto reveal-soft">
        ...
        <section className="section bg-[var(--cream)] relative">
          <SprigCorner
            className="top-8 left-4 w-24 h-24 text-[var(--sage-400)]/20 anim-sway"
          />

          <div className="section-inner">
            <div className="max-w-3xl mx-auto text-center reveal-scale">
              <p
                className="text-[var(--gold)] text-5xl leading-none mb-6 gold-glow"
                style={serifStyle}
              >
                &ldquo;
              </p>
        ...
        <section className="section paper-texture relative -mt-px">
          <SprigCorner
          ...
          <SprigCorner
            className="bottom-0 left-0 w-44 h-44 text-[var(--gold)]/15 anim-sway"
          />

          <div className="section-inner">
            <div className="relative mb-20">
              <span className="editorial-number block leading-none">
                01
              </span>

              <div className="-mt-16 md:-mt-24 relative z-10 section-heading">
                <p
            ...
            <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-center mb-28 md:mb-40 reveal-left">
              ...
              <div className="md:col-span-7 md:pl-6 text-center md:text-left">
                ...
                <div className="section-line h-px bg-[var(--gold)]/50 mb-5 mx-auto md:mx-0" />
            ...
            <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-center reveal-right">
              <div className="md:col-span-7 md:pr-6 order-2 md:order-1 text-center md:text-right">
                ...
                <div className="section-line h-px bg-[var(--gold)]/50 mb-5 mx-auto md:ml-auto md:mr-0" />
        ...
        <section className="section bg-[var(--cream)] relative -mt-px">
          <SprigCorner
            className="top-8 left-4 w-28 h-28 text-[var(--sage-400)]/25 anim-float"
          />
            ...
            <div className="grid md:grid-cols-12 gap-12 items-center">
              ...
              <div className="md:col-span-5 reveal-left">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-2 sm:gap-3 countdown-visible">
                    {[
                      {
                        label: "Hari",
                        value: timeLeft.hari,
        ...
        <section className="section bg-[var(--cream)] relative -mt-px">
          <SprigCorner
            className="top-8 left-4 w-32 h-32 text-[var(--sage-400)]/20 anim-float"
          />
          ...
          <div className="section-inner">
            <div className="relative mb-14">
              ...
              <div className="-mt-16 md:-mt-24 relative z-10 max-w-xl section-heading">
                <p
                  className="text-[var(--gold)] text-3xl md:text-4xl mb-2"
                  style={scriptStyle}
                >
            ...
            <div className="grid sm:grid-cols-2 gap-8 sm:gap-6 max-w-3xl gift-cards-visible">
              {[
                {
                  bank: "BCA",
                  number: "3452461533",
                ...
                <div
                  key={account.number}
                  className="gift-card-wrap"
                >
                  <div className={`atm-card ${account.variant}`}>
                    <div className="atm-card-inner">
                      <div className="atm-card-top">
                        <span className="atm-card-bank">
                          {account.bank}
                        </span>

                        <span
                          className="atm-card-chip"
                          aria-hidden="true"
                        />
                      </div>

                      <div>
                        <p className="atm-card-label">
                          Card Number
                        </p>
        ...
        <footer className="relative overflow-hidden bg-[var(--sage-900)] text-[var(--cream)] px-6 py-28 text-center -mt-px">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(215,193,154,0.08),transparent_60%)]" />

          <SprigCorner
            className="top-0 left-0 w-40 h-40 text-[var(--champagne)]/30 anim-sway"
          />
          ...
          <div className="relative z-10 max-w-xl mx-auto footer-content">
            <p
        ...
        <button
          ...
          aria-label={
            musicPlaying ? "Matikan musik" : "Putar musik"
          }
        >
...
function PhotoFrame({
  ...
  return (
    <div
      className={`photo-frame-oval ${className}`}
    >
      ...
      <div className="photo-frame-oval-inner image-reveal">
        <img
          src={src}
          alt={alt}
        />
...
function LeafOrnament() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M5 55 C20 40, 35 25, 55 5" />

      <path d="M15 45 C10 38, 12 30, 20 28 C22 36, 20 42, 15 45 Z" />

      <path d="M25 35 C20 28, 22 20, 30 18 C32 26, 30 32, 25 35 Z" />

      <path d="M35 25 C30 18, 32 10, 40 8 C42 16, 40 22, 35 25 Z" />

      <path d="M20 50 C14 48, 8 42, 12 34 C20 38, 22 44, 20 50 Z" />

      <path d="M30 40 C24 38, 18 32, 22 24 C30 28, 32 34, 30 40 Z" />

      <path d="M40 30 C34 28, 28 22, 32 14 C40 18, 42 24, 40 30 Z" />
    </svg>
  );
}
...
function SprigCorner({
  className = "",
  flipX = false,
}) {
  return (
    <div
      className={`sprig-corner ${
        flipX ? "sprig-flip-x" : ""
      } ${className}`}
    >
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M5 5 C40 40, 90 70, 140 110" />

        <path d="M30 30 C25 18, 32 10, 45 8 C44 22, 38 28, 30 30 Z" />

        <path d="M45 45 C38 34, 46 26, 60 24 C58 38, 52 44, 45 45 Z" />

        <path d="M62 62 C55 50, 64 42, 78 40 C76 54, 70 60, 62 62 Z" />

        <path d="M80 80 C73 68, 82 60, 96 58 C94 72, 88 78, 80 80 Z" />

        <path d="M100 100 C93 88, 102 80, 116 78 C114 92, 108 98, 100 100 Z" />

        <path d="M120 118 C114 106, 122 98, 136 96 C134 110, 128 116, 120 118 Z" />

        <path d="M22 42 C12 38, 8 30, 12 20 C24 24, 28 32, 22 42 Z" />

        <path d="M38 60 C28 56, 24 48, 28 38 C40 42, 44 50, 38 60 Z" />

        <path d="M56 78 C46 74, 42 66, 46 56 C58 60, 62 68, 56 78 Z" />

        <path d="M74 96 C64 92, 60 84, 64 74 C76 78, 80 86, 74 96 Z" />

        <path d="M94 116 C84 112, 80 104, 84 94 C96 98, 100 106, 94 116 Z" />
